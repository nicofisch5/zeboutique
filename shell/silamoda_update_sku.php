        ...
        try {
            ...
            while (false !== ($csvLine = $io->streamReadCsv("\t"))) {
                ...
                */
                ...
                // Products that begin with SKU master
                $coll = Mage::getModel('catalog/product')->getCollection()
                            ->addFieldToFilter('type_id', 'simple')
                            ->addFieldToFilter('sku', array('eq'=>$csvLine[0].'%'))
                            ->addFieldToFilter('attribute_set_id', $this->_attSet);


                if ($coll->getSize() == 0) {
                    // Si produit non trouvé on parcours les produits simples du derniers configurable trouvé
                }
                
                // Si produit simple on met à jour

                // Si produit configurable on stocke dans une variable ses produits simples
                // et on parcours la suite des lignes CSV
