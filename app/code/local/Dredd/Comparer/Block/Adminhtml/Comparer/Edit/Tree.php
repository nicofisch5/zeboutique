<?php
class Dredd_Comparer_Block_Adminhtml_Comparer_Edit_Tree extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('comparer/categories.phtml');
    }
    ...
    {
        $categoryIds = explode(',', $this->getComparer()->getCategoryIds());
		return $categoryIds;
    }
...
//        $root = parent::getRoot();
    ...
    public function getRoot($parentNodeCategory=null, $recursionLevel=3)
    {
        /**
		* Tester la version
		* Si 1.4+, utiliser autre code
		*/
		// >= 1.4
		$version = Mage::getVersion();
		$t_version = explode('.', $version);
		if (isset($t_version[1]) && $t_version[1]>=4) {
