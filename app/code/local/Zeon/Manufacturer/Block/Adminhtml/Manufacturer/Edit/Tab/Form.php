    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        if (!Mage::app()->isSingleStoreMode()) {
         ...
         $fieldset->addField('is_display_home', 'select', array(
        ...
        $fieldset->addField('manufacturer_logo', 'Thumbnail', array(
           'label'     => Mage::helper('zeon_manufacturer')->__('Manufacturer Logo'),
           'required' => 'true',
           'name'      => 'manufacturer_logo',
        ));

        $fieldset->addField('manufacturer_banner', 'Thumbnail', array(
