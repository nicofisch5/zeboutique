...
class Zeon_Manufacturer_Adminhtml_Manufacturer_ListController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        if ($id = $this->getRequest()->getParam('id')) {
            ...
            Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('zeon_manufacturer')->__('The manufacturer has been deleted.'));
            // go to grid
            $this->_redirect('*/*/');
            return;
            } catch (Mage_Core_Exception $e) {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_manufacturer')->__('An error occurred while deleting manufacturer data. Please review log and try again.'));
                Mage::logException($e);
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('zeon_manufacturer')->__('Unable to find a manufacturer to delete.'));
        // go to grid
        $this->_redirect('*/*/');
    }
    ...
    public function massDeleteAction()
    {
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_manufacturer')->__('An error occurred while mass deleting manufacturer. Please review log and try again.'));
                Mage::logException($e);
                return;
            }
        }
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_manufacturer')->__('An error occurred while mass updating manufacturer. Please review log and try again.'));
                Mage::logException($e);
                return;
            }
        }
