 ...
 *
 * @category    Zeboutique
 * @package     Zeboutique_Ilxelle
 * @author      Zeboutique
 */
class Zeboutique_Ilxelle_Model_Stock extends Zeboutique_Zcore_Model_Stock
{
    
    const URL_STOCK_FILE = 'http://www.sexshop-grossiste.com/stock.php';
    
    protected $_prefix = 'ilxelle';
