 ...
 */
class Quadra_Be2bill_Model_Paypal extends Quadra_Be2bill_Model_Abstract
{

    protected $_code = 'be2bill_paypal';
    ...
    public function getCheckoutFormFields()
    {
        ...
        $params = array_merge($this->getBaseParameters(), $this->getServerToServerParameters($order->getRemoteIp()));
        ...
        if (isset($params['3DSECURE']))
            unset($params['3DSECURE']);

        if (isset($params['CARDFULLNAME']))
            unset($params['CARDFULLNAME']);
